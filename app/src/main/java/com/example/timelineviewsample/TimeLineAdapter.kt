...
import com.example.timelineviewsample.utils.DateTimeUtils
import com.example.timelineviewsample.utils.VectorDrawableUtils
    ...
    override fun onBindViewHolder(holder: TimeLineViewHolder, position: Int) {
        ...
        when {
            ...
            timeLineModel.status == OrderStatus.ACTIVE -> {
                ...
                holder.timeline.marker = VectorDrawableUtils.getTextMarker(
                    holder.itemView.context,
                    position.toString()
                )
            }
        ...
        if (timeLineModel.date.isNotEmpty()) {
            ...
            holder.date.text =
                DateTimeUtils.parseDateTime(timeLineModel.date, "yyyy-MM-dd HH:mm", "hh:mm a, dd-MMM-yyyy")
        } else
